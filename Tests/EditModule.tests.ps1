...
# describes the function Format-String
Describe -Name 'Format-String' -Fixture {
...
Context 'Running without arguments'   {
  ...
  It 'runs without errors' {
    ...
    # scriptblock (braces):
    { Format-String } | Should Not Throw
  }
}
Context 'Running with arguments'   {
  ...
  It 'does something' {
    # call function Format-String and pipe the result to an assertion
    # Example:
    # Format-String | Should Be 'Expected Output'
    # Hint: 
    ...
    Format-String | Should Be Not BeNullOrEmpty 
  }
